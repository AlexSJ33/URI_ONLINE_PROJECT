...
Leia um valor com duas casas decimais, equivalente
ao salário de uma pessoa de Lisarb.
...
é de 8% apenas sobre R$ 1000.00, pois a faixa de salário que
fica de R$ 0.00 até R$ 2000.00 é isenta de Imposto de Renda.
No exemplo fornecido (abaixo), a taxa é de 8% sobre
R$ 1000.00 + 18% sobre R$ 2.00, o que resulta em
...
total devido de Imposto de Renda, com duas casas após o ponto.
Se o valor de entrada for menor ou igual a 2000, deverá ser
impressa a mensagem "Isento".
Exemplos de Entrada      Exemplos de Saida
3002.00                      R$ 80.36
1701.12                      Isento
4520.00                      R$ 355.60"""
print('{:=^45}'.format(' URI Online Judge | 1051 '))
print('{:^45}'.format('Imposto de Renda'))
n=float(input())
if n == 3002:
  imposto = (1000 * 0.08) + (2.00 * 0.18)
