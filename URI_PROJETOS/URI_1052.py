...
Saída
Imprima por extenso o nome do mês correspondente
ao número existente na entrada, com a primeira letra em maiúscula."""

print('{:=^45}'.format(' URI Online Judge | 1052 '))
print('{:^45}'.format('Mês em Inglês'))
